...
* Get error response from mock server (no retry) - http://localhost:8080/books/mock-api/4?error=true
* Get error response from mock server (retry logic) - http://localhost:8080/books/mock-api/4?error=true&retry=true
